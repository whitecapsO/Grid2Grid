...
countGrid1 = grid1Coordinates.count
countGrid2 = grid2Coordinates.count
device.log(message='grid1Coordinates: ' + str(countGrid1) + ' grid2Coordinates:' + str(countGrid2), message_type='success')           
